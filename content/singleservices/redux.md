...
service_small_desc: 'Redux is an open-source JavaScript library designed for managing application state. It is primarily (but not mandatorily) used together with React for building user interfaces. Redux was created by Dan Abramov and Andrew Clark in 2015. Redux is inspired by Facebook’s Flux and influenced by functional programming language Elm.'
